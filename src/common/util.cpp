...
*/
const int compareFloatValues(const float a, const float b, const size_t epsilon) {
	/*
	...
	The error becomes a count of "the maximum number of lexico-numbers allowed between lexico-a and lexico-b."
